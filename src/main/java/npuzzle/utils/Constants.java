...
public class Constants {
	...
	public static final String UNIFORM = "unifrom";
	...
	public static final String ALGORITHM_DESCRIPTION = "Algorithm type to use.";
	public static final String HEURISTIC_DESCRIPTION = "Heuristic function to use.";
	public static final String FILE_DESCRIPTION = "File to use as source of input.";
