...
class FivesTest {
	...
	@Test void manhattanGreedy() {
		testRandom(1,5, GREEDY, MANHATTAN, 15);
	}

	@Test void manhattanUniform() {
		testRandom(1,5, UNIFORM, MANHATTAN, 15);
	}
	...
	@Test void euclideanGreedy() {
		testRandom(1,5, GREEDY, EUCLIDEAN, 15);
	}

	@Test void euclideanUniform() {
		testRandom(1,5, UNIFORM, EUCLIDEAN, 15);
	}

	@Test void euclideanAstar() {
		testRandom(1,5, ASTAR, EUCLIDEAN, 15);
	}
